...
######################################
# Görev 3: create_cltv_p Fonksiyonu ile Predictive CLTV Segmentlerini Oluşturunuz. Amaç segmentleri oluşturmak.
######################################
...
# bu id'lere göre df'i indirgeyelim
...
######################################
# Görev 5: Her bir segment için birliktelik kuralları üretelim
######################################
...
#önerileri ve idleri kontrol edelim
cltv_p.loc[cltv_p.index.isin(germany_ids)]
